...
add_action('wp_loaded', 'genesis_javascript_detection');
function genesis_javascript_detection() {
    if (current_theme_supports('javascript-detection')) {
        add_action( 'genesis_before', 'genesis_javascript_detection', 0 );
...
function wpb_custom_new_menu() {
  register_nav_menu('my-custom-menu',__( 'My Custom Menu' ));
   register_nav_menu('my-custom-bottom-menu',__( 'My Custom Bottom Menu' ));
}
add_action( 'init', 'wpb_custom_new_menu' );

/******* Start Custom Post Code*******/
/*
* Creating a function to create our CPT
*/

function get_youtube_palylistvideo($playlist){
...
//echo "<pre>" ; print_R($json); die;
 //   $playlist = 'PLHfCvJnDwnCz05iKRMbYdQ5NiL5C4JOyZ';
    ...
    foreach($json['items'] as $video){
        ...
        $videos[] = array('title'=>$title,'video'=>$v_id,'thumbnail'=>$thumbnails_url); 
	}
	return $videos ;
}
